          ...
          {all_products.map((e) => {
            if (cartItems[e.id] > 0) {
              return (
                <tr
                  key={e.id}
                  className="border-b border-slate-900/20 text-gray-30 p-6 mdedium-14 text-center"
                >
                  ...
                  <td>NPR.{e.new_price}</td>
                  <td className="w-16 h-16 bg-white">{cartItems[e.id]}</td>
                  <td>NPR.{e.new_price * cartItems[e.id]}</td>
                  <td>
        ...
        <div className="flex flex-col gap-10">
          ...
          <div>
            <div className="flexBetween py-4">
              ...
              <h4 className="text-gray-30 font-semibold">NPR.{getTotalCartAmount()}</h4>
            </div>
            <hr />
            <div className="flexBetween py-4">
            ...
            <div className="flexBetween py-4">
              ...
              <h4 className="bold-18">NPR.{getTotalCartAmount()}</h4>
            </div>
          </div>
